...
const Home = () => {
  ...
  return (
      <div name="Home" className="w-full bg-gradient-to-b from-white via-white to-gray-800 min-h-screen">
          <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center min-h-screen ml-auto px-10 md:flex-row'>  
               <br/>
               <br/>
               <br/>
               <div className='container-adjust'>
                    <div className='image_container'>
                            ...
                            <div className='mid'>
                                <p className='text'><GiFlowerEmblem className='flex flex-row'/> Photo taken at the MSU Gardens <GiFlowerEmblem className='flex flex-row'/></p>
                            </div>
                    </div>
               </div>
                <div className='flex flex-col justify-center min-h-screen'>
                    ...
                    <div>
                        <Link to="Skills" smooth duration={500} className="group text-slate-600 w-fit px-6 py-3 flex items-center rounded-md bg-white opacity-90 border-2 border-slate-600 cursor-pointer">
                            Skills
